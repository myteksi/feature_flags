...
== City Flags ==
  ...
  $feature_flags.city_features(city_id: <city_id>, features: [:cashless, :betauser, :non_existent_feature])
...
== User Flags ==
  ...
  $feature_flags.user_features(id: <user_id>, city_id: <city_id>, features: [:cashless, :betauser, :non_existent_feature])
